...
const countries = [
    ...
    { name: `C̫te d'Ivoire`, alpha2: 'CI', alpha3: 'CIV' },
            ...
            return this.sendMessage(message.channel, {
                embed: {
                    ...
                    fields: [
                        ...
                        {
                            name: 'Area',
                            value: `${countryareakm.toLocaleString('en')}km\xB2 (${countryaream}mi\xB2)`,
                            inline: true,
                        },
                    ],
                    timestamp: new Date(),
